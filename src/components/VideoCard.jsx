...
function VideoCard({ video, setDelStatus, cat }) {
    ...
    return (
        <>
            <Card style={cat ? { width: '10 rem' } : { width: '18rem' }} className='ms-3 mb-3' draggable onDragStart={(e) => { handleOnDrag(e, video?.id) }}>
                ...
                <Card.Body className='d-flex flex-row justify-content-between'>
                    ...
                    <i className="fa-solid fa-trash" onClick={() => { handleDelete(video.id) }} style={cat ? { display: 'none' } : { color: '#f00a0a' }}></i>
