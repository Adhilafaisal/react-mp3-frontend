      ...
      <div className='bg-light w-100 d-flex flex-column justify-content-center'>
        <div className='row p-5'>
          <div className='col'>
            ...
            <p style={{textAlign:'justify'}}>In publishing and graphic design, Lorem ipsum is a placeholder text commonly used to demonstrate the visual form of a
              document or a typeface without relying on meaningful content. Lorem ipsum may be used as a placeholder before the final
              copy is available.</p>
          </div>
          <div className='col'>
            <h4>Links</h4>
